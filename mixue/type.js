function Get_type_(g) {
    ...
    return N = sig(g) + '|' + 0 + '|' + datetime + '|1',
        g = ua(N, true)
}

// console.log(Get_type_('https://mxsa.mxbc.net/api/v1/h5/marketing/secretword/confirm{"marketingId":"1816854086004391938","round":"11:00","secretword":"茉莉奶绿销量突破2000万杯","sign":"88a2356c436d6119429f74fda80c357b","s":2,"stamp":1722843019426}'))
