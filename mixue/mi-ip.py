...
def get_timestamp():
    ...
    return timestamp
tk1='eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ3eG1pbmlfMTgxNzQ3NjEyNTE0OTI1MzYzMyIsImlhdCI6MTcyMjE1NTA0OX0.JW-OISnqicgJ7APPKZVeBCiq0A0AlX-i0oKPbZr2Deu2FsID5vVaiRi-sUVlbO7hqtOsUIxow8IYXlU98AmHgg'
...
def send_request(secretword,inttimestam,tk,ip):
    ...
    response = requests.post('https://mxsa.mxbc.net/api/v1/h5/marketing/secretword/confirm', headers=headers,proxies=proxy,data=N.encode(), timeout=3)
...
def get_proxy():
    ...
    r = requests.get("http://pandavip.xiongmaodaili.com/xiongmao-web/apiPlus/vgl?secret=b6840f11b6ca4cb1bf1e6e022eea51f9&orderNo=VGL20240730141017TGnJuqAR&count=1&isTxt=0&proxyType=1&validTime=0&removal=1&cityIds=&returnAccount=2", verify=False, allow_redirects=False)
    r.encoding='utf8'
    #print(r.status_code)
    #print(r.text)
...
if __name__ == '__main__':
    ...
    print(to_be_encode)
    # send_request(secretword,inttimestam,tk1,pro[0])
# for i in range(30):
