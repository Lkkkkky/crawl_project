...
def get_proxy():
    ...
    r = requests.get("http://pandavip.xiongmaodaili.com/xiongmao-web/apiPlus/vgl?secret=b6840f11b6ca4cb1bf1e6e022eea51f9&orderNo=VGL20240730141017TGnJuqAR&count=10&isTxt=0&proxyType=1&validTime=0&removal=0&cityIds=&returnAccount=2", verify=False, allow_redirects=False)
    r.encoding='utf8'
    #print(r.status_code)
    #print(r.text)
...
def bug(ip):
    ...
    headers = {
        ...
        'Access-Token': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ3eG1pbmlfMTgxNzQ3NjEyNTE0OTI1MzYzMyIsImlhdCI6MTcyMjE1NTA0OX0.JW-OISnqicgJ7APPKZVeBCiq0A0AlX-i0oKPbZr2Deu2FsID5vVaiRi-sUVlbO7hqtOsUIxow8IYXlU98AmHgg',
