...
s='68444628'
l = W['prototype']['\u0024\u005f\u0042\u0042\u0045\u0044'](W['prototype']['\u0024\u005f\u0046\u0044\u005f'](trace), c,s);  //aa
console.log(l)
userresponse=H(38, '074ad60ce0890b3dd14179aa425ddf468m')
console.log('userresponse------>'+userresponse)
o={
    "lang": "zh-cn",
    "userresponse": "559d5522a8e3b",    //好了
    "passtime": 241,   //通过时间
    "imgload": 84,
    "aa": "V(!!TDsssssssssssssssssssssssssssssssrsxssssssx(!!(**-.*.,--,,.7***)**,)*)*)**))*,)))*),*,C-/m",  //  轨迹加密生成
    "ep": {
        "v": "7.9.2",
        "$_BIE": false,
        "me": true,
    ...
    "h9s9": "1816378497",
    "rp": "3d15130b1846279bcc60316d3eaf5d58"
}
// 09b9fa89bf50d1539d7638bdfc938cafa7    ---->新的challenge
// 019924a82c70bb123aae90d483087f94    ---->gt
rp = X('019924a82c70bb123aae90d483087f94' + '09b9fa89bf50d1539d7638bdfc938caf'.slice(0, 32) + o["passtime"]);
console.log(rp)
    u =  new U()[mwbxQ.$_Cg(392)](rt())
        console.log('u------>'+u)
    , l = V['encrypt'](gt['stringify'](o), rt())
            console.log(l)
    , h = m['$_FEX'](l)
console.log(h)
