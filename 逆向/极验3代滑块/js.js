...
function lt(t) {
    ...
    for (; $_DBEEs !== mwbxQ.$_DW()[3][12]; ) {
        switch ($_DBEEs) {
            case mwbxQ.$_DW()[0][13]:
                this[$_CJES(52)] = $_CJFt(51) == typeof t ? h[$_CJFt(50)](t) : t;
...
// ttt=W['prototype']['\u0024\u005f\u0046\u0044\u005f'](trace)    // 根据轨迹加密生成
// console.log(ttt)
var V = function() {
...
resrt=rt()
tr=[[-24, -15, 0], [0, 0, 0], [9, 0, 122], [18, 0, 137], [26, 0, 155], [33, 0, 171], [40, 0, 191], [46, 0, 209], [52, 0, 227], [57, 0, 238], [63, 0, 251], [67, 0, 265], [72, 0, 285], [76, 0, 302], [80, 0, 315], [83, 0, 328], [86, 0, 343], [90, 0, 355], [92, 0, 365], [95, 0, 384], [98, 0, 403], [100, 0, 422], [102, 0, 432], [104, 0, 450], [106, 0, 465], [107, 0, 479], [109, 0, 491], [110, 0, 505], [112, 0, 519], [113, 0, 539], [114, 0, 551], [115, 0, 569], [116, 0, 580], [117, 0, 597], [118, 0, 614], [119, 0, 624], [120, 0, 640], [121, 0, 650], [122, 0, 680], [123, 0, 713], [124, 0, 741], [125, 0, 774], [126, 0, 820], [127, 0, 859], [128, 0, 928], [129, 0, 1028], [130, 0, 1256], [130, 0, 1256]]
c=[12, 58, 98, 36, 43, 95, 62, 15, 12]
s='2d6d7837'
gt1='019924a82c70bb123aae90d483087f94'
cha='e813ad06fb2210c08dfdf93a56c561dc6b'
function get_w(str_trace,str_c,_s,_gt,_cha){
    // var _trace=parseJSONCapture(str_trace)
    // var _c=parseJSONCapture(str_c)

    var _dis= str_trace[str_trace.length - 1][0]
    var _passtime=str_trace[str_trace.length - 1][2]
    console.log(_dis)
    o={
        "lang": "zh-cn",
        "userresponse": H(_dis, _cha),    //好了
        "passtime": _passtime,   //通过时间
        "imgload": 84,
        "aa": W['prototype']['\u0024\u005f\u0042\u0042\u0045\u0044'](W['prototype']['\u0024\u005f\u0046\u0044\u005f'](str_trace), str_c,_s),  //  轨迹加密生成
        "ep": {
            "v": "7.9.2",
            "$_BIE": false,
            "me": true,
        ...
        "h9s9": "1816378497",
        "rp": X(_gt + _cha['slice'](0, 32) + _passtime)
    }
// 09b9fa89bf50d1539d7638bdfc938cafa7    ---->新的challenge
// 019924a82c70bb123aae90d483087f94    ---->gt


    u =  new U()[mwbxQ.$_Cg(392)](rt())
    l = V['encrypt'](gt['stringify'](o), rt())  //2个rt()是否需要一样  存疑
    h = m['$_FEX'](l)
    return h+u
}
function parseJSONCapture(str) {
    try {
...
console.log(get_w(tr, c, s, gt1, cha));
