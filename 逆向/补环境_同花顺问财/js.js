// http://iwencai.com/unifiedwap/home/index

var TOKEN_SERVER_TIME = 1728976691.753;
window=this
...
document={
    getElementsByTagName:function(x){return [watch({},'document_getElementsByTagName')]},
    createElement:function (x){console.log(x)
    if (x=='div'){
        return watch({},'document_createElement')
    }
    return {}
    },
    addEventListener:function(x1,x2){
        return watch({},'document_addEventListener')
