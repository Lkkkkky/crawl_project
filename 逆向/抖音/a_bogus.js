...
document={
    ...
    createElement:function(tag_name){
        ...
        return watch({
            classList:watch({},"document_createElement_classList")
        },"document_createElement_classList")

    },
    documentElement:watch({},"document_documentElement"),
    createEvent:function(event_name){
        console.log("创建事件",event_name)
        return watch({},"document_createEvent")
    },
    body:watch({
        clientWidth:114514,
        clientHeight:114514
    },"document_body"),body:watch({
        clientWidth:114514,
        clientHeight:114514
    },"document_body"),
    // documentElement:watch({},"document_addEventListener"),
...
navigator={
    ...
    vendorSubs:watch({"ink":1724121538490},"navigator_vendorSubs"),
    platform:"Win32"
}
screen={
    availWidth:1920,
...
localStorage={
    getItem:function(key){
        console.log("localStorage_getItem取值. key===>",key);
        if (key==='xmst'){
            return 'bAo4oCPds9MgaEkAusHhim_GbKzxOOqsLm3h8NM7JK_v54XS36HOmzqNEaH5t0QpEivIecR-iQZvJYsmCberxM2K1QiTzWJ5jCKJEugccfc0rDO2w7A='
        }
    }
}
sessionStorage={}
...
window.XMLHttpRequest=function(){
    console.log("XMLHttpRequest被调用")
}
window.onwheelx={
    "_Ax":"0X21"
}
window . innerWidth=507
                            ...
                            if (m < 37)
                                ...
                                if (m < 58)
                                    ...
                                    c = i[r++],
                                        ...
                                        s === 1582 && c===6 ? (window.get_a_b = e,window.rrr=[s,c,v]) : 0,
                                         // s === 7526 && c===1 ? (window.get_a_b = e,window.rrr=[s,c,v]) : 0,
                                        u._u = e,
                                        p[++d] = u
                                }
                            else if (m < 69)
...
//         "args": [
//             "GET",
//             "https://www.douyin.com/aweme/v1/web/comment/list/?device_platform=webapp&aid=6383&channel=channel_pc_web&aweme_id=7407849332168297738&cursor=0&count=20&item_type=0&insert_ids=&whale_cut_token=&cut_version=1&rcFT=&update_version_code=170400&pc_client_type=1&version_code=170400&version_name=17.4.0&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Chrome&browser_version=128.0.0.0&browser_online=true&engine_name=Blink&engine_version=128.0.0.0&os_name=Windows&os_version=10&cpu_core_num=8&device_memory=8&platform=PC&downlink=8.6&effective_type=4g&round_trip_time=50&webid=7405825751654811163&msToken=7b1mpjA5kQJ0JYDHm_53iq1m2rWp1tpR653Ps50sy1d2PON27bEo4uEqPF2eItZGGAp8WDhf7hx4jBhuZ0XosJlkuxUjheKPerVGHgFTcphZnvshR57V&msToken=7b1mpjA5kQJ0JYDHm_53iq1m2rWp1tpR653Ps50sy1d2PON27bEo4uEqPF2eItZGGAp8WDhf7hx4jBhuZ0XosJlkuxUjheKPerVGHgFTcphZnvshR57V&a_bogus=OjmqQm8fmDDT6VWg53ILfY3q66P3Yg7R0trEMD2fTVvSkg39HMPL9exLsqkvcD6jN4%2FkIeYjy4hSYpHMx5CJA3vRHuDKUIcMmDSkKl5Q5xSSs1Xce6UgrUkP-hsACFrQsv1lxOfkoXIrSY8mAxAJ5kIlO62-zo0%2F9lg%3D&a_bogus=OjmqQm8fmDDT6VWg53ILfY3q66P3Yg7R0trEMD2fTVvSkg39HMPL9exLsqkvcD6jN4%2FkIeYjy4hSYpHMx5CJA3vRHuDKUIcMmDSkKl5Q5xSSs1Xce6UgrUkP-hsACFrQsv1lxOfkoXIrSY8mAxAJ5kIlO62-zo0%2F9lg%3D",
//             true
//         ]
//     },
//     "1": 0,
...
args= [
    ...
    1,
    12,
    "device_platform=webapp&aid=6383&channel=channel_pc_web&sec_user_id=MS4wLjABAAAAwAlRMqIMw_EpFfNFpdYX-pqALXOlVB7KtmFH5CUlEUc&max_cursor=1700588545000&locate_query=false&show_live_replay_strategy=1&need_time_list=0&time_list_query=0&whale_cut_token=&cut_version=1&count=18&publish_video_strategy_type=2&update_version_code=170400&pc_client_type=1&version_code=290100&version_name=29.1.0&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Edge&browser_version=128.0.0.0&browser_online=true&engine_name=Blink&engine_version=128.0.0.0&os_name=Windows&os_version=10&cpu_core_num=8&device_memory=8&platform=PC&downlink=10&effective_type=4g&round_trip_time=50&webid=7341451502348879375&verifyFp=verify_m04tkch2_vu0KsKuh_Wy2Z_4Usb_9iIv_ozTFEaRH6mWJ&fp=verify_m04tkch2_vu0KsKuh_Wy2Z_4Usb_9iIv_ozTFEaRH6mWJ&msToken=bAo4oCPds9MgaEkAusHhim_GbKzxOOqsLm3h8NM7JK_v54XS36HOmzqNEaH5t0QpEivIecR-iQZvJYsmCberxM2K1QiTzWJ5jCKJEugccfc0rDO2w7A%3D&msToken=bAo4oCPds9MgaEkAusHhim_GbKzxOOqsLm3h8NM7JK_v54XS36HOmzqNEaH5t0QpEivIecR-iQZvJYsmCberxM2K1QiTzWJ5jCKJEugccfc0rDO2w7A%3D",
    "",
...
function get_a_bogus(args){
    res = window.get_a_b(window.rrr[0],args,window.rrr[1],window.rrr[2],null);
    console.log(res);
}
// const jsonString=process.argv.slice(2);
// const args=JSON.parse(jsonString);
// console.log("Received data:",args);
// console.log('$$'+res+'$$');
res=get_a_bogus(args)
console.log(res)
process.exit(1)