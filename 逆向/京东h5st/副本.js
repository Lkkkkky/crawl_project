                ...
                switch (o[a++]) {
                    ...
                    case 20:
                        if (x[x.length - 2] != null) {
                            ...
                            if (x.length === 6) {
                                x[x.length - 3] = x[x.length - 3].split('=')[1]
                                x[x.length - 3] = JSON.parse(x[x.length - 3])
                                x[x.length - 3].extend.ls = 5
                                x[x.length - 3].extend.bu3 = 89
                                x[x.length - 3].extend.bu4 = 0
                                x[x.length - 3].extend.bu6 = 34
                                x[x.length - 3].extend.bu8 = 0
                                x[x.length - 3] = JSON.stringify(x[x.length - 3])
                                x[x.length - 3] = ('__collect envCollect=').concat(x[x.length - 3])
                            }
                            // 补环境点 canvas
