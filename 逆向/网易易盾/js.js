...
function U() {
    ...
    R = 'NECaptchaSafeWindow'
        ...
        _j = document['getElementById'](R);
        _j && (document['body']['removeChild'](_j),
            _j = null);
    }
...
function P_(T, m, O) {
    ...
    switch (T['length']) {
        case 0x1:
            N = T[0x0],
                J = q = 0x0,
                _S['push'](m[N >>> 0x2 & 0x3f], m[(N << 0x4 & 0x30) + (J >>> 0x4 & 0xf)], O, O);
            break;
        case 0x2:
            N = T[0x0],
                J = T[0x1],
                q = 0x0,
                _S['push'](m[N >>> 0x2 & 0x3f], m[(N << 0x4 & 0x30) + (J >>> 0x4 & 0xf)], m[(J << 0x2 & 0x3c) + (q >>> 0x6 & 0x3)], O);
            break;
        case 0x3:
            N = T[0x0],
                J = T[0x1],
                q = T[0x2],
                _S['push'](m[N >>> 0x2 & 0x3f], m[(N << 0x4 & 0x30) + (J >>> 0x4 & 0xf)], m[(J << 0x2 & 0x3c) + (q >>> 0x6 & 0x3)], m[0x3f & q]);
            break;
        default:
            return '';
    }
...
function z1(x) {
    return x < -0x80 ? z1(0x100 + x) : x > 0x7f ? z1(x - 0x100) : x;
}
function z2(T, m, O) {
...
function Q(x) {
    ...
    x = '' + x;
    for (var F = [], b = U(), w = b['safeGlobal'], D = 0x0, B = 0x0, I = x["length"] / 0x2; D < I; D++) {
...
function CE(x) {
    ...
    for (var F = [], b = 0x0, w = x['length']; b < w; b++)
        '%' === x['charAt'](b) ? b + 0x2 < w && F['push'](Q('' + x['charAt'](++b) + x['charAt'](++b))[0x0]) : F['push'](z1(x['charCodeAt'](b)));
    return F;
}
function Z() {

    for (var CO = [], CN = 0x0; CN < 0x4; CN++)
        CO[CN] = z1(Math['floor'](0x100 * Math['random']()));
    return CO;
}
function E(x) {
    var F = [];
    return F[0x0] = z1(x >>> 0x18 & 0xff),
        F[0x1] = z1(x >>> 0x10 & 0xff),
        F[0x2] = z1(x >>> 0x8 & 0xff),
        F[0x3] = z1(0xff & x),
        F;
}
...
function F(CO) {
    ...
    CN = Q('')
        , Ct = function (CV) {
...
function CX(T, m, O) {
    var N = 'MB.CfHUzEeJpsuGkgNwhqiSaI4Fd9L6jYKZAxn1/Vml0c5rbXRP+8tD3QTO2vWyo'
        , J = '7';
    return z2(T, N['split'](''), J);
}
function CC(CO) {
    for (var CN = CE(CO), Ct = C7(), CJ = CM(Ct, 0x2), Cq = CJ[0x0], CS = CJ[0x1], CV = CE(S(CN)), Cy = J([]['concat'](K(CN), K(CV))), Cn = q(Cy), Ce = []['concat'](K(CS)), Ci = Cq, Cx = 0x0, CF = Cn['length']; Cx < CF; Cx++) {
...
function C6(CO) {
    ...
    for (var CN = [C5, H, _C2, C0, C3, C1, C4], Ct = '037606da0296055c', CJ = 0x0, Cq = Ct['length']; CJ < Cq;) {
...
console.log(get_cb());
console.log(CC('256uKT9ccNJYvPlOHGdcEYBiPi2Rn8TZ').length);


//fp
ddd = '__snaker__id=owWSyM5zHZnA0Mxr; _qddac=3-3-1.1.ek10uc.m1t74inv; Register-Referer=https://dun.163.com/trial/jigsaw; Hm_lvt_4671c5d502135636b837050ec6d716ce=1727953874; HMACCOUNT=0E7D89894D8D5CB3; __root_domain_v=.163.com; gdxidpyhxdE=J76RKxlbD1zM6sQst5K1mcDh%2BAqxfE1i5LUVC07CGhg1gXvKVOCtjvGROVdy6VYCP5hggAekN5H4rB9%2F2cm%2FWe7qrt46PR%2FM3koLHLgn%2BkSDS0lYXc6S2K7dKMlsNVpddJtJD1949tV9imR1D22792RzEWRJGvZzqSk3%5CWk0j5UUkDiq%3A1727954778023; ntes_utid=tid._.56AxtjOR7HpEBgQVRRLTAyABtNIXkeOr._.0.%2C.edd._.._.0; _qddaz=QD.140427953875633; _qdda=3-1.1; _qddab=3-ek10uc.m1t74inv; Hm_lpvt_4671c5d502135636b837050ec6d716ce=1727954456'
setTimeout=function (){}
